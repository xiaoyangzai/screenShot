...
uint8_t *decode_jpeg (const char *filename, uint32_t *width,uint32_t *height,uint32_t *bpp)
{
...
uint32_t * rgb24to32(uint8_t *buf24, uint32_t width,uint32_t height)
{
	int w = width;
	int h = height;
...
uint16_t * rgb24to16(uint8_t *buf24, uint32_t width,uint32_t height)
{
	uint16_t *buf16 = NULL;
	...
	if ((buf16 = (uint16_t *)malloc (w * h * 2)) == NULL)
		return NULL;
